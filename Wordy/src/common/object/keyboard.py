...
class Keyboard:
    ...
    def getLetter(self, letter):
        return self.letterDict.get(letter)
    
    def getKeyboardRow1(self):
        return self.keyboardRow1
    
    def getKeyboardRow2(self):
        return self.keyboardRow2
    
    def getKeyboardRow3(self):
        return self.keyboardRow3